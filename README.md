...
- [RustChain](https://github.com/Scottcjn/RustChain) - DePIN blockchain with Proof-of-Antiquity consensus. Rewards vintage hardware (PowerPC, SPARC, MIPS) with higher mining weight, creating incentive to preserve older computing equipment instead of e-waste.
